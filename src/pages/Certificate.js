...
function Certificate({ setActiveIcon }) {
  ...
  const profile = {
    ...
    avatar: "https://cdn-icons-png.flaticon.com/512/5968/5968906.png",
  };
  ...
  return (
    <div
      className={`flex  flex-col w-full h-full transform transition-all duration-1000 origin-bottom
        ${visible ? "opacity-100 scale-100" : "opacity-0 scale-0"}`}
    >
      <div className="flex flex-col bg-black/80 rounded-xl w-full h-full">
        ...
        <div className="flex items-center gap-3 p-4 border-b border-gray-700">
          <img src={profile.avatar} alt="Medium Avatar" className="w-12 h-12 rounded-full" />
          <div>
